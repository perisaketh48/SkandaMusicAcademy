...
const LearnMusicOnline = () => {
  ...
  return (
    <section className="py-14 sm:py-16 bg-gradient-to-br from-[#0D2137] via-[#125699] to-[#0D3F73] text-white relative overflow-hidden">
          ...
          <div className="fade-in-up">
            ...
            <div className="flex flex-col sm:w-[60%] lg:w-[50%]">
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-[#125699] hover:bg-white/90 font-semibold shadow-md"
              >
                <Link to="/courses">
                  Explore Our Courses
